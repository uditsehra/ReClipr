...
struct ReCliprApp: App {
    // AppDelegate creates the store during applicationDidFinishLaunching, after
    // StorageMigration has run, so clipboard monitoring begins at launch — not
    // lazily on the first menu click.
